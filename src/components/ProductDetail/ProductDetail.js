...
const [img,setImg] = useState("")
    ...
    // let url =  `https://pepperfrydb1.herokuapp.com/furniture/`;
     const dispatch = useDispatch()
    //    useEffect(() => {
    //        dispatch(storeData(url))
    //     },url);
	...
	const fetchData = async () => {
		// return axios({
		//   url: ` https://pepperfrydb1.herokuapp.com/furniture/${id}`,
		//   method: 'GET',
		//   params: {},
		//})
...
<>
	...
	<div>
		<img src="https://thumbs.dreamstime.com/b/letter-logos-120926491.jpg" alt="" className="img1 " onClick={handleProduct}/>
	</div>
<div className=" mt-5" >
       <input type="text"placeholder="What are you loooking" className="search"  />
        </div>
